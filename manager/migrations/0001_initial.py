    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('analyzer', models.ForeignKey(on_delete=django.db.models.deletion.RESTRICT, to='lead_manager.device', verbose_name='Оборудование')),
                ('customer', models.ForeignKey(on_delete=django.db.models.deletion.RESTRICT, to='lead_manager.customer', verbose_name='Пользователь')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('device', models.ForeignKey(on_delete=django.db.models.deletion.RESTRICT, to='lead_manager.deviceinfield', verbose_name='Оборудование')),
            ],
            options={
                'verbose_name': 'Заявка',
